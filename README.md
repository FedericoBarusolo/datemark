...
- **Automatic Event Detection**: Extract events and their details from any webpage text
- **Intelligent Parsing**: AI architecture to extract event names, dates, times, and locations
- **Filtering By Query**: Optionally insert a user query to filter events
...
## Test Coverage
### Main
[![codecov](https://codecov.io/gh/FedericoBarusolo/datemark/branch/main/graph/badge.svg)](https://codecov.io/gh/FedericoBarusolo/datemark)
### Dev
[![codecov](https://codecov.io/gh/FedericoBarusolo/datemark/branch/dev/graph/badge.svg)](https://codecov.io/gh/FedericoBarusolo/datemark)
...
🔗 **[Add to Chrome](https://chromewebstore.google.com/detail/datemark/aoldddfllaacoiihcnjhkhljoaoogabc)** *(Chrome Web Store link)*

### Usage

1. Navigate to any webpage containing event information
2. Click the Datemark extension icon
3. Optionally insert a filtering query (e.g. _'events in the weekend'_)
4. Click on the "Extract Events" button
5. Allow Google authentication (for first access)
6. The extension will automatically scan and extract events 
7. Review the detected events in the popup 
8. Edit any details as needed (name, date, time, location)
9. Select one or multiple events 
10. Click "Add Events to Calendar" to insert into Google Calendar
...
- Using event filtering with input query will consume an additional 
user credits with respect to simple extraction
